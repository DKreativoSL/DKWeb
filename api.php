            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
							<div class="col-md-12 text-left">
								...
								<br>
								<ul>
									<li>email: El email del usuario.</li>
									<li>contraseña: La contraseña del usuario.</li>
								</ul>
							</div>
    	                   	<div class="col-md-12 text-left">
    	                   		<strong>Devuelve</strong>
    	                   		<br>Información basica del usuario (id, nombre, email)
	                   		</div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-9">
							<div class="col-md-12 text-left"><strong>Recibe</strong><br><ul><li>id: id de la publicación a recuperar.</li></ul></div>
    	                   	<div class="col-md-12 text-left"><strong>Devuelve</strong><br> La publicación con el id que corresponda. <br>
                            	Si es de tipo, básico o avanzado, la estructura será comprendida de la siguiente manera en formato JSON: id, titulo, descripcion, seccion, orden. <br>Si es de tipo personalizado la estructura variará dependiendo de los campos de la misma.</div>
                        </div>
                    </div>
                    <hr>
					<div class="row">
                        ...
                        <div class="col-md-9">
							<div class="col-md-12 text-left">
								...
								<br>
								<ul>
									<li>idPadre: id de la sección padre (no obligaotio)</li>
								</ul>
							</div>
    	                   	<div class="col-md-12 text-left">
    	                   		<strong>Devuelve</strong><br>
								Si no se especifica idPadre, enviará todas las secciones del sitio web<br>
					...
					<div class="row">
                        ...
                        <div class="col-md-9">
							<div class="col-md-12 text-left"><strong>Recibe</strong><ul>
    	                   	...
    	                   	<div class="col-md-12 text-left"><strong>Devuelve</strong><br> Las publicaciones de una sección en concreto o de todas, pudiendo limitar el inicio y la cantidad de registros a devolver. <br> Además se puede ordenar de forma ascendente (según se han ido creando) o descendente (para devolver la última publicación como la primera del JSon).</div>
                        </div>
                    </div>
                    <hr>
					<div class="row">
