...
<div class="logo">
	<a href="index.php">
	<img src="./../images/dkweb-logo-m.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<!--<form class="login-form" action="index.php" method="post">-->
		<h3 class="form-title">Entrar en Dk Web 2.0</h3>
		<div class="alert alert-danger display-hide">
			<button class="close" data-close="alert"></button>
			<span>
			Introduce tu usuario y contrase&ntilde;a. </span>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" id="password"/>
			</div>
		</div>
		<div class="form-actions">
			<!--<label class="checkbox">
			<input type="checkbox" name="remember" value="1"/> Remember me </label> -->
			<button id="botonEntrarLogin" type="submit" class="btn blue pull-right">
